...
public class CriteriaFiltro5 {
	public static void main(String[] args) {
		...
		Predicate maiorQue = builder.greaterThan(livro.get("preco"), 40.00);
		
		Predicate menorQue = builder.lessThan(livro.get("preco"), 50.00);

		Predicate predicate = builder.and(maiorQue, menorQue);
